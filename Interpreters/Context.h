...
public:
    ...
    std::vector<String> getCurrentRolesNames() const;
    //std::vector<UUID> getEnabledRoles() const;
    std::vector<String> getEnabledRolesNames() const;
    ...
    acquireNamedSession(const String & session_id, std::chrono::steady_clock::duration timeout, bool session_check);
