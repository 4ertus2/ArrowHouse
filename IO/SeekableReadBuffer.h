...
public:
    ...
    virtual size_t getFileOffsetOfBufferEnd() const { throw Exception("Method getFileOffsetOfBufferEnd() not implemented"); }
    ...
    virtual size_t readBigAt(char * /*to*/, size_t /*n*/, size_t /*offset*/, const std::function<bool(size_t m)> & /*progress_callback*/) const
        { throw Exception("Method readBigAt() not implemented"); }
